        ...
        <div class="wrapper">
            <div class="sidebar">
                ...
                <ul>
                    ...
                    <li><a href="inventory.php"><i class='bx bx-food-menu' ></i></i>Inventory</a></li>
                    ...
                    <li><a href="onlineorder.php"><i class='bx bx-notepad'></i>Online Orders</a></li>
                    <li><a href="orderhistory.php?page=1"><i class='bx bx-time' ></i></i>Order History</a></li>
